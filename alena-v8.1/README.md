...
│  ├─ vbv-daten.js         Versicherungen/Leben: 31 Kapitel VBV-Stoff
...
| Versicherungen | Leben | VBV/AFA – Vorsorge und Sozialversicherungen, 31 Kapitel, 394 Einträge |
...
Der Stoff für die **VBV/AFA-Prüfung, Modul Leben**: **31 Kapitel, 394
...
|---|---|---|
| Grundlagen | Kennzahlen, Fristen, Systemaufbau | 72 |
| Fallwerte | Renten, Beiträge, Grenzwerte, Fristen im Fall | 130 |
| Zusammenhänge | Verfahren, Koordination, Kürzungen, Kontrollfragen | 131 |
| Prüfungsreif | Rechenwege, Feinheiten, Stolpersteine, Beratung | 61 |
...
BVV 3 (fedlex.admin.ch, faq.bsv.admin.ch, finma.ch, svv.ch, vbv.ch), sowie auf die gesetzlichen Grundzüge (AHVG, IVG, EOG, AVIG, BVG,
