...
│  ├─ vbv-daten.js         Versicherungen/Leben: VBV-Vorsorgefälle
...
| **Versicherungen** | **Leben** | **VBV/AFA – Vorsorgegrafiken, 12 Kapitel, 147 Einträge** |
...
Quelle: **VBV/AFA, Modul Leben – Vorsorgegrafiken**, Ansätze 2025, Skala 44.
Aus dem JSON gebaut, ohne etwas dazuzuerfinden: eine Testprüfung vergleicht
jede Zahl im Datensatz mit der Quelle.

### Kapitel

Drei Grundlagenkapitel und je fünf beziehungsweise sechs zu den beiden Fällen:

| Kapitel | Inhalt |
|---|---|
| Grundlagen und Kennzahlen | Ansätze, Skala, UVG-Höchstverdienst, 3a-Maximum |
| Wartefristen | UVG, IV, BVG, Krankentaggeld |
| Koordination und Überentschädigung | Komplementärrente, BVV 2 Art. 24, Säule 3 |
| Fall … – Ausgangslage | Person, Löhne, Bedarf, Vorsorgeausweis |
| Fall … – Leistungen und Phasen | Renten und je Phase Quellen, Total, Lücke, Deckungsgrad |
| Fall … – Rechenwege und Merksätze | Komplementärrente, Kürzung, Dauern, Kapitalbedarf |
| Fall … – Kontrollfragen | Prüfungsfragen und Stolpersteine |
| Fall Nessier – Lösungsvorschlag | Produkt, Rente, Wartefrist, Alternativen |

Jede Frage trägt den Fallnamen (`Berger:` / `Nessier:`), weil beide Fälle
dieselben Fragen mit anderen Zahlen beantworten – ohne das wäre *Zuordnen*
ein Ratespiel.
...
|---|---|---|
| Grundlagen | Kennzahlen, Fristen, Ausgangslagen | 27 |
| Fallwerte | Renten, Phasen, Totale und Lücken | 59 |
| Zusammenhänge | Koordination, Kürzungen, Kontrollfragen | 41 |
| Prüfungsreif | Rechenwege, Stolpersteine, Beratung | 20 |

### Übungsart Vorsorgegrafik

Die Phasen eines Falls kommen gemischt als Bausteine; du legst die Treppe in
der richtigen Reihenfolge. Nach dem Prüfen erscheint die ganze Grafik mit
Total, Lücke und Deckungsgrad je Phase – dort sitzt der Lernwert, nicht in
einem einzelnen Wert. Fälle wandern nicht in die Leitner-Kästchen; sie zählen
nur für die Bilanz der Runde.
