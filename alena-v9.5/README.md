...
│  ├─ franz-daten.js       Französisch: 35 Kapitel Wortschatz, Zahlen 0–200
│  ├─ eng-daten.js         Englisch: Job Interviews, 8 Unterkategorien
│  ├─ vbv-daten.js         Versicherungen/Leben: 38 Kapitel VBV-Stoff
...
|---|---|---|
| Französisch | Wortschatz | *Le vocabulaire de base* – 35 Kapitel, 1943 Einträge |
| Englisch | Job Interviews | KV Zürich, Kapitel 1 – 8 Unterkategorien, 105 Einträge |
| Versicherungen | Leben | VBV/AFA – Vorsorge und Sozialversicherungen, 38 Kapitel, 549 Einträge |
...
Der Stoff für die **VBV/AFA-Prüfung, Modul Leben**: **38 Kapitel, 549
...
| Frühpensionierung und Aufschub | Flexible Pensionierung, Teilvorbezug und Teilaufschub, Kürzungssätze, Teilpensionierung in der 2. Säule |
| Erste Säule – IV | Eingliederung vor Rente, stufenloses Rentensystem, Wartezeit, Kinderrente |
| Eingliederungsmassnahmen der IV | Die fünf Arten, Früherfassung und Frühintervention, die sieben beruflichen Massnahmen, Hilfsmittel, Taggeld |
...
| Begünstigung und Erbrecht | Todesfallkapital der Pensionskasse nach Art. 20a BVG, Begünstigung im UVG, Vergleich über alle Säulen, Pflichtteile nach dem Erbrecht 2023 |
| Vorsorgeauftrag und Patientenverfügung | Form, die drei Bereiche, Validierung durch die KESB, gesetzliches Vertretungsrecht |
| Erbrecht in der Beratung | Parentelen, gesetzliche Erbteile, Güterstand, Testament und Erbvertrag, Konkubinat |
| Was die Heirat verändert | Wirkung in der 1., 2. und 3. Säule sowie im Erbrecht und Güterrecht |

**Weitere Zweige und Beratung**

| Kapitel | Inhalt |
|---|---|
| Unfallversicherung UVG | Unfallbegriff nach ATSG mit allen Merkmalen, unfallähnliche Körperschädigungen, Deckung, Taggeld, Rente, Komplementärrente, Nachdeckung, Abredeversicherung |
...
| Geldwäscherei und GwG | Aufsicht durch FINMA und SRO, Identifikation der Vertragspartei, Herkunft der Mittel, Meldung an die Meldestelle |
| AIA und FATCA | Beide Abkommen mit vollem Namen, wann welches greift, was für Lebensversicherungen meldepflichtig ist |
...
|---|---|---|
| Grundlagen | Kennzahlen, Fristen, Systemaufbau, Abkürzungen, Begriffe | 96 |
| Fallwerte | Renten, Beiträge, Grenzwerte, Fristen im Fall | 192 |
| Zusammenhänge | Verfahren, Koordination, Kürzungen, Kontrollfragen | 170 |
| Prüfungsreif | Rechenwege, Feinheiten, Stolpersteine, Beratung | 91 |
...
kantonalen Steuermerkblätter zur Vorsorgebesteuerung (ag.ch, baselland.ch, gr.ch)
sowie GwG, AIA und FATCA (sro-svv.ch, sif.admin.ch), sowie auf die gesetzlichen Grundzüge (AHVG, IVG, EOG, AVIG, BVG,
...
## Lernatelier – Englisch

Unter `/lernen` steckt als Fach **Englisch** das Kapitel 1 des KV-Handouts
*German-English Vocabulary List for Job Interviews* (I. Montaguti &
M. Ingletti, 2025): **8 Unterkategorien, 105 Einträge**, aus dem Handout
abgeschrieben. Vorne steht das Englische, hinten das Deutsche.

| Unterkategorie | Inhalt | Einträge |
|---|---|---|
| 1. General Terms | Allgemeine Begriffe: Bewerbung, Abteilungen, Firma | 21 |
| 2. Education & Qualifications | Ausbildung und Qualifikationen | 12 |
| 3. Work Experience | Berufserfahrung, Team, Verantwortung | 17 |
| 4. Personal Strengths | Persönliche Stärken als Adjektive | 10 |
| 5. Job Conditions | Vertragsbedingungen: Gehalt, Probezeit, Kündigung | 8 |
| 6. Common Action Verbs | Häufige Aktionsverben fürs Gespräch | 18 |
| 7. Describing Yourself | Ganze Sätze zur Selbstbeschreibung | 12 |
| 8. Self-Description Starters | Satzanfänge zum Weiterbauen | 7 |

### Niveaus

| Stufe | Was drinsteckt | Einträge |
|---|---|---|
| Einfach | Kurze, häufige Wörter | 69 |
| Mittel | Mehrteilige Ausdrücke und Fachbegriffe | 17 |
| Sätze | Ganze Sätze und Satzanfänge (Kapitel 7 und 8) | 19 |

Im Handout steht *„I would describe myself as…“* zweimal – einmal für „Ich
beschreibe mich selbst als…“, einmal für „Ich würde mich selbst als …
bezeichnen“. Zwei gleiche Karten wären beim **Zuordnen** nicht lösbar, darum
stehen beide deutschen Formen auf einer Karte. Der Generator liegt in
`scripts/eng-bau.py`.

### Vorlesen in der richtigen Sprache

Jedes Datenmodul sagt über `SPRACHE`, in welcher Sprache die Sprachausgabe
liest (`fr-FR`, `en-GB`). Beim Fachwechsel sucht `/lernen` eine passende
Stimme neu – zuerst die genaue Sprache, sonst irgendeine der Sprachfamilie.
Fehlt `SPRACHE`, bleibt es bei Französisch.
...
Listes de vocabulaire*: **35 Kapitel, 1943 Einträge**, aus dem PDF gelesen und
gegen ein französisches und ein deutsches Wörterbuch geprüft.

Das Kapitel *LES CHIFFRES* ist neu gebaut: **0 bis 200 lückenlos der Reihe
nach**, danach die Hunderter, Tausender, Millionen und Milliarden sowie
Jahreszahlen – und am Schluss die Regeln zu *et un*, zum s bei
*quatre-vingts* und *cent* und zum unveränderlichen *mille*. Nur die
französische Variante: septante, huitante und nonante kommen nicht vor. Der
Generator dazu liegt in `scripts/franz-zahlen.py`.
...
| Stufe | Was drinsteckt | Einträge |
|---|---|---|
| Einfach | Grundwortschatz: Zahlen bis 20, Familie, Körper, Küche | 705 |
| Mittel | Alltag: Zahlen bis 100, Kleider, Sport, Berufe, Gesundheit | 637 |
| Schwer | Zahlen über 100, Charakter, Medien, Künste, Arbeitsbedingungen | 460 |
