...
export const FAECHER = [
  ...
  },
  {
    ...
    unterfaecher: [{
      id: 'job-interviews',
      name: 'Job Interviews',
      titel: 'Kapitel 1 – German-English Vocabulary List',
      beschreibung: 'KV Zürich – Wortschatz fürs Vorstellungsgespräch, in acht Unterkategorien.',
      vorneName: 'Englisch',
      hintenName: 'Deutsch',
      modi: ['stufen', 'karteikarten', 'auswahl', 'tippen', 'satzbau', 'zuordnen', 'hoeren'],
      laden: () => import('/eng-daten.js'),
    }],
  },
  {
    id: 'versicherungen',
    ...
    unterfaecher: [{
      id: 'leben',
      name: 'Leben',
      titel: 'Vorsorge und Sozialversicherungen',
      beschreibung: 'VBV/AFA – Modul Leben: Sozialversicherungen, Vorsorge und Produkte. Zahlen Stand 2026.',
      vorneName: 'Frage',
      hintenName: 'Antwort',
      modi: ['stufen', 'karteikarten', 'auswahl', 'tippen', 'zuordnen'],
